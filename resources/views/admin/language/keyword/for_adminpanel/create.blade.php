                            ...
                            @if (isset($menu_keyword))
                                <form action="{{ route('menu-keyword.update_menu_keyword', $menu_keyword->id) }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="color_option">Color Option <span class="text-red">*</span></label>
                                                <input type="text" name="color_option" class="form-control" id="color_option" value="{{ $menu_keyword->color_option }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                ...
                                <form action="{{ route('menu-keyword.store_menu_keyword') }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="color_option">Color Option <span class="text-red">*</span></label>
                                                <input type="text" name="color_option" class="form-control" id="color_option" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary mr-2">{{ __('content.submit') }}</button>
                                ...
                                <form action="{{ route('content-six-group-keyword.update_content_six_group_keyword', $content_six_group_keyword->id) }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="color_option">Color Option <span class="text-red">*</span></label>
                                                <input type="text" name="color_option" class="form-control" id="color_option" value="{{ $content_six_group_keyword->color_option }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary mr-2">{{ __('content.submit') }}</button>
