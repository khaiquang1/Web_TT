...
<!-- Error Section Start -->
<div class="error-area vh d-flex" data-background="<?php echo e(asset('uploads/common_dummy/404.jpg')); ?>" data-overlay-light="94">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                <div class="error-inner text-center">
                    ...
                    <a class="cs-btn-one btn-md btn-primary-color" href="<?php echo e(url('/')); ?>">Return Home</a>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\novaly\resources\views/errors/404.blade.php ENDPATH**/ ?>